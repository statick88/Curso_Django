...
-   Los modelos en Django representan la estructura de la base de datos.

-   Cada modelo se define como una clase Python que hereda de
    models.Model.

-   Los atributos de la clase representan los campos de la tabla en la
    base de datos.
