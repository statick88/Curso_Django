...
+-----------------------------------------------------------------------+
| +------------+------------+------------+------------+                 |
| | Ca         | SQLite     | MySQL      | PostgreSQL |                 |
| | ra         |            |            |            |                 |
| | cterística |            |            |            |                 |
| +:===========+:==========:+:==========:+:==========:+                 |
| | Tipo       | Base de    | Base de    | Base de    |                 |
| |            | datos      | datos      | datos      |                 |
| |            | i          | externa    | externa    |                 |
| |            | ncorporada |            |            |                 |
| |            | en Django  |            |            |                 |
...
| |            | o          | c          | c          |                 |
| |            | ncurrentes | o          | o          |                 |
| |            | limitadas  | ncurrentes | ncurrentes |                 |
| +------------+------------+------------+------------+                 |
| | E          | Limitada   | Buena      | Excelente  |                 |
| | sc         |            |            |            |                 |
| | alabilidad |            |            |            |                 |
| +------------+------------+------------+------------+                 |
| | Soporte    | Ligero y   | A          | A          |                 |
| |            | simple     | mpliamente | mpliamente |                 |
| |            |            | utilizado  | utilizado  |                 |
| +------------+------------+------------+------------+                 |
| | I          | No         | Requiere   | Requiere   |                 |
| | nstalación | requiere   | i          | i          |                 |
| |            | i          | nstalación | nstalación |                 |
| |            | nstalación | de         | de         |                 |
| |            | de         | servidor   | servidor   |                 |
| |            | servidor   | MySQL      | PostgreSQL |                 |
| +------------+------------+------------+------------+                 |
| | R          | Rápido y   | Buen       | Excelente  |                 |
| | endimiento | adecuado   | r          | r          |                 |
| |            | para a     | endimiento | endimiento |                 |
| |            | p          | y e s      | y e s      |                 |
| |            | licaciones | c          | c          |                 |
| |            | pequeñas o | alabilidad | alabilidad |                 |
| |            | prototipos |            |            |                 |
| +------------+------------+------------+------------+                 |
| | U          | Ideal para | A          | A          |                 |
| | tilización | a          | mpliamente | mpliamente |                 |
| |            | p          | utilizado  | utilizado  |                 |
| |            | licaciones | en a       | en a       |                 |
| |            | de         | p          | p          |                 |
| |            | desarrollo | licaciones | licaciones |                 |
| |            | o pruebas  | web y e m  | web y e m  |                 |
| |            |            | p          | p          |                 |
| |            |            | resariales | resariales |                 |
| +------------+------------+------------+------------+                 |
| | Fl         | Menos      | C          | Altamente  |                 |
| | exibilidad | opciones   | o          | c          |                 |
| |            | de c o     | nfigurable | o          |                 |
| |            | n          | y p e r    | nfigurable |                 |
| |            | figuración | s          | y p e r    |                 |
| |            |            | onalizable | s          |                 |
| |            |            |            | onalizable |                 |
| +------------+------------+------------+------------+                 |
+-----------------------------------------------------------------------+
...
Los formularios en Django se utilizan para crear y manejar formularios
HTML.

Django proporciona una clase ModelForm que genera automáticamente un
