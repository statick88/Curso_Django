...
|                                  | esenciales:                      |
+----------------------------------+----------------------------------+
| **init.py**                      | Este archivo indica a Python que |
|                                  | el directorio es un paquete y    |
...
|                                  | las URLs del proyecto, es decir, |
|                                  | cómo se manejan las solicitudes  |
|                                  | y se mapean a las vistas.        |
+----------------------------------+----------------------------------+
...
Verás que se ha creado un nuevo directorio llamado "mi_blog" que
contiene la estructura inicial del proyecto.
...
Ahora, crea una nueva aplicación llamada "blog" utilizando el siguiente
comando:
